...
I heard your heart and made Lua Class lib for you.
...
The lib is inspired by and modeled on Python OOP. Although the two languages are quite different, it doesn't matter when it come to the essence of OOP. The major points are:
