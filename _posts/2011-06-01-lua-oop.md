...
tags:   oo lua python
excerpt: "What's OOP on earth? How to do it Lua? And what's Lua Class Lib? Let's take an interesting tour to OOP in Lua."
---
[Project at GitHub](https://github.com/coin8086/lua-class-lib)

_This article assumes readers have a basic knowledge on Lua. And to understand the last part, "Design and Implementation", a good Lua knowledge is required and some knowledge on Python OOP is a plus._

What's OOP on earth? How to do it Lua? And what's Lua Class Lib? Let's take an interesting tour to OOP in Lua.
...
> "But I want a more good-looking way for OOP in Lua, as C++/Java/Python/... does, which is more convenient!"

I heard your complains. Here Lua Class lib comes to your rescue!
...
The _class_ in above code is really a user defined function to do all the magic, and it's not a keyword in the language! Really cool, isn't it? Thanks to the power of the Lua language, it's not hard to do.
...
The lib is inspired by and modeled on Python OOP. Although the two languages are quite different, it doesn't matter when we come to the essence of OOP. The major points are:
